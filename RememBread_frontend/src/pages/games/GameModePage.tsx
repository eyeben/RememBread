    ...
    <div className="min-h-[calc(100vh-126px)] flex flex-col items-center px-4">
      ...
      <div className="w-full flex flex-col max-w-[384px] mt-4">
        <CustomButton
          ...
          icon={<Memory  className="w-14 h-14 flex-shrink-0 ml-2" />}
        ...
        <CustomButton
          ...
          className="bg-primary-200"
          icon={<Compare className="w-14 h-14 flex-shrink-0 ml-2" />}
        ...
        <CustomButton
          ...
          className="bg-primary-200"
          icon={<Shadow className="w-14 h-14 flex-shrink-0 ml-2" />}
        ...
        <CustomButton
          ...
          description="무슨 빵일까?"
          className="bg-primary-200"
          icon={<Detective className="w-14 h-14 flex-shrink-0 ml-2" />}
