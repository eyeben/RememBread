...
const Footer = () => {
  ...
  return (
    <>
      ...
      <footer className="fixed flex justify-evenly bottom-0 left-0 right-0 w-full pc:border-x h-16 bg-white border-t border-neutral-200 z-50 pb-[env(safe-area-inset-bottom)]">
        <FooterItem
